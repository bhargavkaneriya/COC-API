...
router.post("/product-add", async (req, res) => {
  try {
    if (!req.body.dealer_id || !req.body.product_id || !req.body.name || !req.body.product_code || !req.body.price || !req.body.type) {
      jsonResponse(
        res,
...
router.get("/transaction-list", async (req, res) => {
  try {
    ...
    const response = await dealerHandler.transactionList(req.query);
    jsonResponse(res, responseCodes.OK, null, response);
  } catch (error) {
    console.log("error", error);
    try {
...
router.get("/dashboard", async (req, res) => {
  try {
    ...
    const response = await dealerHandler.dashboard(req.query);
    jsonResponse(res, responseCodes.OK, null, response);
  } catch (error) {
    console.log("error", error);
    try {
...
router.get("/payment-receipt-list", async (req, res) => {
  try {
    if (!req.query.dealer_id) {
      jsonResponse(
        res,
    ...
    const response = await dealerHandler.paymentReceiptList(req.query);
    jsonResponse(res, responseCodes.OK, null, response);
  } catch (error) {
    console.log("error", error);
    try {
